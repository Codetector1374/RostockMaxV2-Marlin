...
#define CUSTOM_MACHINE_NAME "RostockMaxV2"
...
#define MANUAL_Z_HOME_POS 360 + 10 // Distance between the nozzle to printbed after homing
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 92.4}   // default steps per unit for PowerWasp
#define DEFAULT_MAX_FEEDRATE          {300, 300, 300, 60}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {3000, 3000, 3000, 12000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.

#define DEFAULT_ACCELERATION          1850    // X, Y, Z and E acceleration in mm/s^2 for printing moves
#define DEFAULT_RETRACT_ACCELERATION  1850    // E acceleration in mm/s^2 for retracts
#define DEFAULT_TRAVEL_ACCELERATION   3000    // X, Y, Z acceleration in mm/s^2 for travel (non printing) moves

// The speed change that does not require acceleration (i.e. the software might assume it can be done instantaneously)
#define DEFAULT_YJERK                16.0    // (mm/sec)
#define DEFAULT_XJERK                16.0    // (mm/sec)
